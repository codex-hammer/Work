...
$db->close();
?>
<img src="Picture1.png" height="77" width="97" align="middle" style="position:absolute ; right:650px">
<?php
	if($_SESSION['email_id'])
	{
	    echo "<a href='logout.php' target='_top' style='position:absolute ; right:10px ; top:30px'>LOGOUT</a>";
	}
	else
	{
