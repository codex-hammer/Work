  ...
  <div class="outer-screen">
    <div class="inner-screen">
      <div class="form">
        ...
        <input type="text" class="zocial-dribbble" placeholder="Project id of Your Choice" name="prochoice" />
        <input type="text" placeholder="Bid Amount" name="bid_amt" />
        <input type="text" placeholder="Time of Submission" name="time" />
